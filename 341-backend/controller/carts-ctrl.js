...
addToCart = async (req, res) => {
    ...
    cart.productsByIsbn = cart.productsByIsbn.push(req.params.isbn);
...
removeFromCart = async (req, res) => {
    try {
      ...
      return res.status(200).json({ success: true, message: "product removed successfully", removedIsbn: removedIsbn });
    } catch (e) {
      console.log(e);
      return res
        .status(500)
